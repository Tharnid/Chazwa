...
namespace DataSamples.ProductClasses
{
    public class ProductManager
    {
        ...
        public List<Product> GetProducts(string sortOrder, DataSamples.ViewModelBaseEnums.SortDirection sortDirection)
        {
            return GetProducts(sortOrder,
              (sortDirection == DataSamples.ViewModelBaseEnums.SortDirection.Ascending ? "ASC" : "DESC").ToString(), null);
        }
        ...
        public List<Product> GetProducts(int pageIndex,
          int pageSize,
          string sortOrder,
          DataSamples.ViewModelBaseEnums.SortDirection sortDirection)
        {
            return GetProducts(pageIndex, pageSize,
              sortOrder,
              (sortDirection == DataSamples.ViewModelBaseEnums.SortDirection.Ascending ? "ASC" : "DESC").ToString());
        }
