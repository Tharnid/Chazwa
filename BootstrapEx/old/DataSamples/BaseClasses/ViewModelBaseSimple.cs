...
namespace DataSamples
{
    public class ViewModelBaseSimple
    {
        ...
        /// </summary>
        public DataSamples.ViewModelBaseEnums.SortDirection SortDirection { get; set; }
        /// <summary>
        /// Get/Set the new sort direction
        /// </summary>
        public DataSamples.ViewModelBaseEnums.SortDirection SortDirectionNew { get; set; }
        /// <summary>
        ...
        public void Init()
        {
            ...
            SortDirection = DataSamples.ViewModelBaseEnums.SortDirection.Ascending;
            SortDirectionNew = DataSamples.ViewModelBaseEnums.SortDirection.Ascending;
        ...
        protected virtual void SetSortDirection()
        {
            ...
            {
                if (SortDirection == DataSamples.ViewModelBaseEnums.SortDirection.Ascending)
                    SortDirection = DataSamples.ViewModelBaseEnums.SortDirection.Descending;
                else
                    SortDirection = DataSamples.ViewModelBaseEnums.SortDirection.Ascending;
            }
            else
        ...
        protected virtual List<T> Sort<T>(IQueryable<T> list)
        {
            ...
            list = list.OrderBy(SortExpression +
              (SortDirection == DataSamples.ViewModelBaseEnums.SortDirection.Ascending ? " ASC" : " DESC"));
