...
{
    public class DMPInitializer :
        //DropCreateDatabaseAlways<DateMePleaseContext>
    DropCreateDatabaseIfModelChanges<DMPContext>
    {
        public DMPInitializer()
        {

        }

        protected override void Seed(DMPContext context)
        {
        ...
        private void AddData(DMPContext context)
        {
