...
namespace MasterDetail.Web.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MasterDetail.DataLayer.ApplicationDbContext>

    {
        ...
        protected override void Seed(MasterDetail.DataLayer.ApplicationDbContext context)
        {
