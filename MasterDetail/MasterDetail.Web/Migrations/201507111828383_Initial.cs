namespace MasterDetail.Web.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        // ExtendedPrice = c.Decimal(nullable: false, precision: 18, scale: 2),  *** Alter table to add as calculated column  ***
        ...
        // Calculated column for Extended Price on labor
        Sql("ALTER TABLE dbo.Labors ADD ExtendedPrice AS CAST(LaborHours * Rate AS Decimal(18, 2))");
                ...
                c => new
                    {
                        ...
                        OrderDateTime = c.DateTime(nullable: false, defaultValueSql: "GetDate()"), // add a default value of GetDate()
                        TargetDateTime = c.DateTime(),
                        DropDeadDateTime = c.DateTime(),
                        Description = c.String(maxLength: 256),
                        WorkOrderStatus = c.Int(nullable: false),
                        // Total = c.Decimal(nullable: false, precision: 18, scale: 2), *** Alter table to add as calculated column  ***
            ...
            // Calculated Column for Work Orders
            ...
            // Calculated colun for Extended Price on Parts
